...
namespace prueba_cft.Controllers
{
    public class EstudiantesController : Controller
    {
        ...
        public EstudiantesController(PruebaCftContext context)
        {
            _context = context;
        }

        //GET: Estudiante/NotasEstudiante/1
        [HttpGet]
        ...
        public async Task<IActionResult> Index()
        {
            return _context.Estudiantes != null ?
                        ...
                        Problem("Entity set 'PruebaCftContext.Estudiantes'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Apellido,Direccion,Email,Rut,Edad,FechaNacimiento,Password")] Estudiante estudiante)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Apellido,Direccion,Email,Rut,Edad,FechaNacimiento,Password")] Estudiante estudiante)
        {
            if (id != estudiante.Id)
            {
                return NotFound();
